...
import MemberImg from "../../assets/images/team member 4.png";
              ...
              <div className="col-md-6 col-lg-3 py-4" key={index}>
                <div className="card shadow border-0">
                  <div className="card-img-top">
                    <img src={team.img} alt="" className="w-100" />
                  </div>
                  <div className="card-body p-4">
                    <div className="card-title pb-0 mb-0">{team.name}</div>
                    <div className="card-sub-title mb-2">{team.designation}</div>
                    <a href="#">
                      <svg
